...
namespace MavLink
{
    ...
    public class Msg_video_stream_information : MavlinkMessage
    {
        ...
        /// Video stream URI
        /// </summary>
        public byte[] uri; // Array size 230
    ...
    /// </summary>
    public class Msg_set_video_stream_settings : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
        {
            return MavLinkSerializer.Serialize_SET_VIDEO_STREAM_SETTINGS(this, bytes, ref offset);
        }
    }

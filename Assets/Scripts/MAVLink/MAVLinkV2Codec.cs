...
namespace MavLink
{
    ...
    public static class MavLinkSerializer
    {
        ...
        public static Dictionary<int, MavPacketInfo> Lookup = new Dictionary<int, MavPacketInfo>
        {
			...
			{256, new MavPacketInfo(Deserialize_SETUP_SIGNING, 71)},
			{257, new MavPacketInfo(Deserialize_BUTTON_CHANGE, 131)},
			{258, new MavPacketInfo(Deserialize_PLAY_TUNE, 187)},
			{259, new MavPacketInfo(Deserialize_CAMERA_INFORMATION, 92)},
			{260, new MavPacketInfo(Deserialize_CAMERA_SETTINGS, 146)},
			{261, new MavPacketInfo(Deserialize_STORAGE_INFORMATION, 179)},
			{262, new MavPacketInfo(Deserialize_CAMERA_CAPTURE_STATUS, 12)},
			{263, new MavPacketInfo(Deserialize_CAMERA_IMAGE_CAPTURED, 133)},
			{264, new MavPacketInfo(Deserialize_FLIGHT_INFORMATION, 49)},
			{265, new MavPacketInfo(Deserialize_MOUNT_ORIENTATION, 26)},
			{266, new MavPacketInfo(Deserialize_LOGGING_DATA, 193)},
			{267, new MavPacketInfo(Deserialize_LOGGING_DATA_ACKED, 35)},
			{268, new MavPacketInfo(Deserialize_LOGGING_ACK, 14)},
			{269, new MavPacketInfo(Deserialize_VIDEO_STREAM_INFORMATION, 58)},
			{270, new MavPacketInfo(Deserialize_SET_VIDEO_STREAM_SETTINGS, 232)},
			{299, new MavPacketInfo(Deserialize_WIFI_CONFIG_AP, 19)},
			{300, new MavPacketInfo(Deserialize_PROTOCOL_VERSION, 217)},
			{310, new MavPacketInfo(Deserialize_UAVCAN_NODE_STATUS, 28)},
			{311, new MavPacketInfo(Deserialize_UAVCAN_NODE_INFO, 95)},
			{320, new MavPacketInfo(Deserialize_PARAM_EXT_REQUEST_READ, 243)},
			{321, new MavPacketInfo(Deserialize_PARAM_EXT_REQUEST_LIST, 88)},
			{322, new MavPacketInfo(Deserialize_PARAM_EXT_VALUE, 243)},
			{323, new MavPacketInfo(Deserialize_PARAM_EXT_SET, 78)},
			{324, new MavPacketInfo(Deserialize_PARAM_EXT_ACK, 132)},
		};
		...
		internal static MavlinkMessage Deserialize_GPS_RAW_INT(byte[] bytes, int offset)
		{
			return new Msg_gps_raw_int
			{
				...
				alt_ellipsoid = bitconverter.ToInt32(bytes, offset + 30),
				h_acc = bitconverter.ToUInt32(bytes, offset + 34),
				v_acc = bitconverter.ToUInt32(bytes, offset + 38),
				vel_acc = bitconverter.ToUInt32(bytes, offset + 42),
				hdg_acc = bitconverter.ToUInt32(bytes, offset + 46),
			};
		}
		...
		internal static MavlinkMessage Deserialize_SERVO_OUTPUT_RAW(byte[] bytes, int offset)
		{
			return new Msg_servo_output_raw
			{
				...
				port = bytes[offset + 20],
				servo9_raw = bitconverter.ToUInt16(bytes, offset + 21),
				servo10_raw = bitconverter.ToUInt16(bytes, offset + 23),
				servo11_raw = bitconverter.ToUInt16(bytes, offset + 25),
				servo12_raw = bitconverter.ToUInt16(bytes, offset + 27),
				servo13_raw = bitconverter.ToUInt16(bytes, offset + 29),
				servo14_raw = bitconverter.ToUInt16(bytes, offset + 31),
				servo15_raw = bitconverter.ToUInt16(bytes, offset + 33),
				servo16_raw = bitconverter.ToUInt16(bytes, offset + 35),
			};
		}
		...
		internal static MavlinkMessage Deserialize_SET_GPS_GLOBAL_ORIGIN(byte[] bytes, int offset)
		{
			return new Msg_set_gps_global_origin
			{
				...
				target_system = bytes[offset + 12],
				time_usec = bitconverter.ToUInt64(bytes, offset + 13),
			};
		}
		...
		internal static MavlinkMessage Deserialize_GPS_GLOBAL_ORIGIN(byte[] bytes, int offset)
		{
			return new Msg_gps_global_origin
			{
				...
				longitude = bitconverter.ToInt32(bytes, offset + 4),
				altitude = bitconverter.ToInt32(bytes, offset + 8),
				time_usec = bitconverter.ToUInt64(bytes, offset + 12),
			};
		}
		...
		internal static MavlinkMessage Deserialize_OPTICAL_FLOW(byte[] bytes, int offset)
		{
			return new Msg_optical_flow
			{
				...
				flow_rate_x = bitconverter.ToSingle(bytes, offset + 26),
				flow_rate_y = bitconverter.ToSingle(bytes, offset + 30),
			};
		}
		...
		internal static MavlinkMessage Deserialize_LANDING_TARGET(byte[] bytes, int offset)
		{
			return new Msg_landing_target
			{
				...
				x = bitconverter.ToSingle(bytes, offset + 30),
				y = bitconverter.ToSingle(bytes, offset + 34),
				z = bitconverter.ToSingle(bytes, offset + 38),
				q =  ByteArrayUtil.ToSingle(bytes, offset + 42, 4),
				type = bytes[offset + 58],
				position_valid = bytes[offset + 59],
			};
		}
		...
		internal static MavlinkMessage Deserialize_HOME_POSITION(byte[] bytes, int offset)
		{
			return new Msg_home_position
			{
				...
				time_usec = bitconverter.ToUInt64(bytes, offset + 52),
			};
		}
		...
		internal static MavlinkMessage Deserialize_SET_HOME_POSITION(byte[] bytes, int offset)
		{
			return new Msg_set_home_position
			{
				...
				time_usec = bitconverter.ToUInt64(bytes, offset + 53),
			};
		}
		...
		internal static MavlinkMessage Deserialize_SETUP_SIGNING(byte[] bytes, int offset)
		{
			return new Msg_setup_signing
			{
				initial_timestamp = bitconverter.ToUInt64(bytes, offset + 0),
				target_system = bytes[offset + 8],
				target_component = bytes[offset + 9],
				secret_key =  ByteArrayUtil.ToUInt8(bytes, offset + 10, 32),
			};
		}

		internal static MavlinkMessage Deserialize_BUTTON_CHANGE(byte[] bytes, int offset)
		{
			return new Msg_button_change
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				last_change_ms = bitconverter.ToUInt32(bytes, offset + 4),
				state = bytes[offset + 8],
			};
		}

		internal static MavlinkMessage Deserialize_PLAY_TUNE(byte[] bytes, int offset)
		{
			return new Msg_play_tune
			{
				target_system = bytes[offset + 0],
				target_component = bytes[offset + 1],
				tune =  ByteArrayUtil.ToChar(bytes, offset + 2, 30),
			};
		}

		internal static MavlinkMessage Deserialize_CAMERA_INFORMATION(byte[] bytes, int offset)
		{
			return new Msg_camera_information
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				firmware_version = bitconverter.ToUInt32(bytes, offset + 4),
				focal_length = bitconverter.ToSingle(bytes, offset + 8),
				sensor_size_h = bitconverter.ToSingle(bytes, offset + 12),
				sensor_size_v = bitconverter.ToSingle(bytes, offset + 16),
				flags = bitconverter.ToUInt32(bytes, offset + 20),
				resolution_h = bitconverter.ToUInt16(bytes, offset + 24),
				resolution_v = bitconverter.ToUInt16(bytes, offset + 26),
				cam_definition_version = bitconverter.ToUInt16(bytes, offset + 28),
				vendor_name =  ByteArrayUtil.ToUInt8(bytes, offset + 30, 32),
				model_name =  ByteArrayUtil.ToUInt8(bytes, offset + 62, 32),
				lens_id = bytes[offset + 94],
				cam_definition_uri =  ByteArrayUtil.ToChar(bytes, offset + 95, 140),
			};
		}

		internal static MavlinkMessage Deserialize_CAMERA_SETTINGS(byte[] bytes, int offset)
		{
			return new Msg_camera_settings
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				mode_id = bytes[offset + 4],
			};
		}

		internal static MavlinkMessage Deserialize_STORAGE_INFORMATION(byte[] bytes, int offset)
		{
			return new Msg_storage_information
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				total_capacity = bitconverter.ToSingle(bytes, offset + 4),
				used_capacity = bitconverter.ToSingle(bytes, offset + 8),
				available_capacity = bitconverter.ToSingle(bytes, offset + 12),
				read_speed = bitconverter.ToSingle(bytes, offset + 16),
				write_speed = bitconverter.ToSingle(bytes, offset + 20),
				storage_id = bytes[offset + 24],
				storage_count = bytes[offset + 25],
				status = bytes[offset + 26],
			};
		}

		internal static MavlinkMessage Deserialize_CAMERA_CAPTURE_STATUS(byte[] bytes, int offset)
		{
			return new Msg_camera_capture_status
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				image_interval = bitconverter.ToSingle(bytes, offset + 4),
				recording_time_ms = bitconverter.ToUInt32(bytes, offset + 8),
				available_capacity = bitconverter.ToSingle(bytes, offset + 12),
				image_status = bytes[offset + 16],
				video_status = bytes[offset + 17],
			};
		}

		internal static MavlinkMessage Deserialize_CAMERA_IMAGE_CAPTURED(byte[] bytes, int offset)
		{
			return new Msg_camera_image_captured
			{
				...
				q =  ByteArrayUtil.ToSingle(bytes, offset + 28, 4),
				image_index = bitconverter.ToInt32(bytes, offset + 44),
				camera_id = bytes[offset + 48],
				capture_result = bitconverter.ToInt8(bytes, offset + 49),
				file_url =  ByteArrayUtil.ToChar(bytes, offset + 50, 205),
			};
		}

		internal static MavlinkMessage Deserialize_FLIGHT_INFORMATION(byte[] bytes, int offset)
		{
			return new Msg_flight_information
			{
				arming_time_utc = bitconverter.ToUInt64(bytes, offset + 0),
				takeoff_time_utc = bitconverter.ToUInt64(bytes, offset + 8),
				flight_uuid = bitconverter.ToUInt64(bytes, offset + 16),
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 24),
			};
		}

		internal static MavlinkMessage Deserialize_MOUNT_ORIENTATION(byte[] bytes, int offset)
		{
			return new Msg_mount_orientation
			{
				time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
				roll = bitconverter.ToSingle(bytes, offset + 4),
				pitch = bitconverter.ToSingle(bytes, offset + 8),
		...
		internal static MavlinkMessage Deserialize_LOGGING_DATA(byte[] bytes, int offset)
		{
			return new Msg_logging_data
			{
				sequence = bitconverter.ToUInt16(bytes, offset + 0),
				target_system = bytes[offset + 2],
				target_component = bytes[offset + 3],
				length = bytes[offset + 4],
				first_message_offset = bytes[offset + 5],
				data =  ByteArrayUtil.ToUInt8(bytes, offset + 6, 249),
			};
		}

		internal static MavlinkMessage Deserialize_LOGGING_DATA_ACKED(byte[] bytes, int offset)
		{
			return new Msg_logging_data_acked
			{
				sequence = bitconverter.ToUInt16(bytes, offset + 0),
				target_system = bytes[offset + 2],
				target_component = bytes[offset + 3],
		...
		internal static MavlinkMessage Deserialize_LOGGING_ACK(byte[] bytes, int offset)
		{
			return new Msg_logging_ack
			{
				sequence = bitconverter.ToUInt16(bytes, offset + 0),
				target_system = bytes[offset + 2],
				target_component = bytes[offset + 3],
		...
		internal static MavlinkMessage Deserialize_VIDEO_STREAM_INFORMATION(byte[] bytes, int offset)
		{
			return new Msg_video_stream_information
			{
				framerate = bitconverter.ToSingle(bytes, offset + 0),
				bitrate = bitconverter.ToUInt32(bytes, offset + 4),
				resolution_h = bitconverter.ToUInt16(bytes, offset + 8),
				resolution_v = bitconverter.ToUInt16(bytes, offset + 10),
				rotation = bitconverter.ToUInt16(bytes, offset + 12),
				camera_id = bytes[offset + 14],
				status = bytes[offset + 15],
				uri =  ByteArrayUtil.ToChar(bytes, offset + 16, 230),
			};
		}

		internal static MavlinkMessage Deserialize_SET_VIDEO_STREAM_SETTINGS(byte[] bytes, int offset)
		{
			return new Msg_set_video_stream_settings
			{
				framerate = bitconverter.ToSingle(bytes, offset + 0),
				bitrate = bitconverter.ToUInt32(bytes, offset + 4),
				resolution_h = bitconverter.ToUInt16(bytes, offset + 8),
				...
				camera_id = bytes[offset + 16],
				uri =  ByteArrayUtil.ToChar(bytes, offset + 17, 230),
			};
		}

		internal static MavlinkMessage Deserialize_WIFI_CONFIG_AP(byte[] bytes, int offset)
		{
			return new Msg_wifi_config_ap
			{
				ssid =  ByteArrayUtil.ToChar(bytes, offset + 0, 32),
				password =  ByteArrayUtil.ToChar(bytes, offset + 32, 64),
			};
		}

		internal static MavlinkMessage Deserialize_PROTOCOL_VERSION(byte[] bytes, int offset)
		{
			return new Msg_protocol_version
			{
				version = bitconverter.ToUInt16(bytes, offset + 0),
				min_version = bitconverter.ToUInt16(bytes, offset + 2),
				max_version = bitconverter.ToUInt16(bytes, offset + 4),
				spec_version_hash =  ByteArrayUtil.ToUInt8(bytes, offset + 6, 8),
				library_version_hash =  ByteArrayUtil.ToUInt8(bytes, offset + 14, 8),
			};
		}

		internal static MavlinkMessage Deserialize_UAVCAN_NODE_STATUS(byte[] bytes, int offset)
		{
			return new Msg_uavcan_node_status
			{
				time_usec = bitconverter.ToUInt64(bytes, offset + 0),
				uptime_sec = bitconverter.ToUInt32(bytes, offset + 8),
				vendor_specific_status_code = bitconverter.ToUInt16(bytes, offset + 12),
				health = bytes[offset + 14],
				mode = bytes[offset + 15],
				sub_mode = bytes[offset + 16],
			};
		}

		internal static MavlinkMessage Deserialize_UAVCAN_NODE_INFO(byte[] bytes, int offset)
		{
			return new Msg_uavcan_node_info
			{
				time_usec = bitconverter.ToUInt64(bytes, offset + 0),
				uptime_sec = bitconverter.ToUInt32(bytes, offset + 8),
				sw_vcs_commit = bitconverter.ToUInt32(bytes, offset + 12),
				name =  ByteArrayUtil.ToChar(bytes, offset + 16, 80),
				hw_version_major = bytes[offset + 96],
				hw_version_minor = bytes[offset + 97],
				hw_unique_id =  ByteArrayUtil.ToUInt8(bytes, offset + 98, 16),
				sw_version_major = bytes[offset + 114],
				sw_version_minor = bytes[offset + 115],
			};
		}

		internal static MavlinkMessage Deserialize_PARAM_EXT_REQUEST_READ(byte[] bytes, int offset)
		{
			return new Msg_param_ext_request_read
			{
				param_index = bitconverter.ToInt16(bytes, offset + 0),
				target_system = bytes[offset + 2],
				target_component = bytes[offset + 3],
		...
		internal static MavlinkMessage Deserialize_PARAM_EXT_REQUEST_LIST(byte[] bytes, int offset)
		{
			return new Msg_param_ext_request_list
			{
				target_system = bytes[offset + 0],
				target_component = bytes[offset + 1],
			};
		...
		internal static MavlinkMessage Deserialize_PARAM_EXT_VALUE(byte[] bytes, int offset)
		{
			return new Msg_param_ext_value
			{
				param_count = bitconverter.ToUInt16(bytes, offset + 0),
				param_index = bitconverter.ToUInt16(bytes, offset + 2),
				param_id =  ByteArrayUtil.ToChar(bytes, offset + 4, 16),
				param_value =  ByteArrayUtil.ToChar(bytes, offset + 20, 128),
				param_type = bytes[offset + 148],
			};
		}

		internal static MavlinkMessage Deserialize_PARAM_EXT_SET(byte[] bytes, int offset)
		{
			return new Msg_param_ext_set
			{
				target_system = bytes[offset + 0],
				target_component = bytes[offset + 1],
				param_id =  ByteArrayUtil.ToChar(bytes, offset + 2, 16),
				param_value =  ByteArrayUtil.ToChar(bytes, offset + 18, 128),
				param_type = bytes[offset + 146],
			};
		}

		internal static MavlinkMessage Deserialize_PARAM_EXT_ACK(byte[] bytes, int offset)
		{
			return new Msg_param_ext_ack
			{
				param_id =  ByteArrayUtil.ToChar(bytes, offset + 0, 16),
				param_value =  ByteArrayUtil.ToChar(bytes, offset + 16, 128),
				param_type = bytes[offset + 144],
				param_result = bytes[offset + 145],
			};
		}
		...
		internal static int Serialize_GPS_RAW_INT(this Msg_gps_raw_int msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.alt_ellipsoid, bytes, offset + 30);
			bitconverter.GetBytes(msg.h_acc, bytes, offset + 34);
			bitconverter.GetBytes(msg.v_acc, bytes, offset + 38);
			bitconverter.GetBytes(msg.vel_acc, bytes, offset + 42);
			bitconverter.GetBytes(msg.hdg_acc, bytes, offset + 46);
			offset += 50;
			return 24;
		}
		...
		internal static int Serialize_SERVO_OUTPUT_RAW(this Msg_servo_output_raw msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 20] = msg.port;
			bitconverter.GetBytes(msg.servo9_raw, bytes, offset + 21);
			bitconverter.GetBytes(msg.servo10_raw, bytes, offset + 23);
			bitconverter.GetBytes(msg.servo11_raw, bytes, offset + 25);
			bitconverter.GetBytes(msg.servo12_raw, bytes, offset + 27);
			bitconverter.GetBytes(msg.servo13_raw, bytes, offset + 29);
			bitconverter.GetBytes(msg.servo14_raw, bytes, offset + 31);
			bitconverter.GetBytes(msg.servo15_raw, bytes, offset + 33);
			bitconverter.GetBytes(msg.servo16_raw, bytes, offset + 35);
			offset += 37;
			return 36;
		}
		...
		internal static int Serialize_MISSION_REQUEST_PARTIAL_LIST(this Msg_mission_request_partial_list msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 4] = msg.target_system;
			bytes[offset + 5] = msg.target_component;
			bytes[offset + 6] = msg.mission_type;
			offset += 7;
			return 37;
		}
		...
		internal static int Serialize_MISSION_ITEM(this Msg_mission_item msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 37] = msg.mission_type;
			offset += 38;
			return 39;
		}
		...
		internal static int Serialize_MISSION_REQUEST(this Msg_mission_request msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 2] = msg.target_system;
			bytes[offset + 3] = msg.target_component;
			bytes[offset + 4] = msg.mission_type;
			offset += 5;
			return 40;
		}
		...
		internal static int Serialize_MISSION_REQUEST_LIST(this Msg_mission_request_list msg, byte[] bytes, ref int offset)
		{
			bytes[offset + 0] = msg.target_system;
			bytes[offset + 1] = msg.target_component;
			bytes[offset + 2] = msg.mission_type;
			offset += 3;
			return 43;
		}
		...
		internal static int Serialize_MISSION_ACK(this Msg_mission_ack msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 3] = msg.mission_type;
			offset += 4;
			return 47;
		}
		...
		internal static int Serialize_SET_GPS_GLOBAL_ORIGIN(this Msg_set_gps_global_origin msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 12] = msg.target_system;
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 13);
			offset += 21;
			return 48;
		}
		...
		internal static int Serialize_GPS_GLOBAL_ORIGIN(this Msg_gps_global_origin msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.longitude, bytes, offset + 4);
			bitconverter.GetBytes(msg.altitude, bytes, offset + 8);
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 12);
			offset += 20;
			return 49;
		}
		...
		internal static int Serialize_OPTICAL_FLOW(this Msg_optical_flow msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.flow_rate_x, bytes, offset + 26);
			bitconverter.GetBytes(msg.flow_rate_y, bytes, offset + 30);
			offset += 34;
			return 100;
		}
		...
		internal static int Serialize_LANDING_TARGET(this Msg_landing_target msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.x, bytes, offset + 30);
			bitconverter.GetBytes(msg.y, bytes, offset + 34);
			bitconverter.GetBytes(msg.z, bytes, offset + 38);
			ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 42, 4);
			bytes[offset + 58] = msg.type;
			bytes[offset + 59] = msg.position_valid;
			offset += 60;
			return 149;
		}
		...
		internal static int Serialize_HOME_POSITION(this Msg_home_position msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 52);
			offset += 60;
			return 242;
		}
		...
		internal static int Serialize_SET_HOME_POSITION(this Msg_set_home_position msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 53);
			offset += 61;
			return 243;
		}
		...
		internal static int Serialize_SETUP_SIGNING(this Msg_setup_signing msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.initial_timestamp, bytes, offset + 0);
			bytes[offset + 8] = msg.target_system;
			bytes[offset + 9] = msg.target_component;
			ByteArrayUtil.ToByteArray(msg.secret_key, bytes, offset + 10, 32);
			offset += 42;
			return 256;
		}

		internal static int Serialize_BUTTON_CHANGE(this Msg_button_change msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bitconverter.GetBytes(msg.last_change_ms, bytes, offset + 4);
			bytes[offset + 8] = msg.state;
			offset += 9;
			return 257;
		}

		internal static int Serialize_PLAY_TUNE(this Msg_play_tune msg, byte[] bytes, ref int offset)
		{
			bytes[offset + 0] = msg.target_system;
			bytes[offset + 1] = msg.target_component;
			ByteArrayUtil.ToByteArray(msg.tune, bytes, offset + 2, 30);
			offset += 32;
			return 258;
		}

		internal static int Serialize_CAMERA_INFORMATION(this Msg_camera_information msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bitconverter.GetBytes(msg.firmware_version, bytes, offset + 4);
			bitconverter.GetBytes(msg.focal_length, bytes, offset + 8);
			bitconverter.GetBytes(msg.sensor_size_h, bytes, offset + 12);
			bitconverter.GetBytes(msg.sensor_size_v, bytes, offset + 16);
			bitconverter.GetBytes(msg.flags, bytes, offset + 20);
			bitconverter.GetBytes(msg.resolution_h, bytes, offset + 24);
			bitconverter.GetBytes(msg.resolution_v, bytes, offset + 26);
			bitconverter.GetBytes(msg.cam_definition_version, bytes, offset + 28);
			ByteArrayUtil.ToByteArray(msg.vendor_name, bytes, offset + 30, 32);
			ByteArrayUtil.ToByteArray(msg.model_name, bytes, offset + 62, 32);
			bytes[offset + 94] = msg.lens_id;
			ByteArrayUtil.ToByteArray(msg.cam_definition_uri, bytes, offset + 95, 140);
			offset += 235;
			return 259;
		}

		internal static int Serialize_CAMERA_SETTINGS(this Msg_camera_settings msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bytes[offset + 4] = msg.mode_id;
			offset += 5;
			return 260;
		}

		internal static int Serialize_STORAGE_INFORMATION(this Msg_storage_information msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bitconverter.GetBytes(msg.total_capacity, bytes, offset + 4);
			bitconverter.GetBytes(msg.used_capacity, bytes, offset + 8);
			bitconverter.GetBytes(msg.available_capacity, bytes, offset + 12);
			bitconverter.GetBytes(msg.read_speed, bytes, offset + 16);
			bitconverter.GetBytes(msg.write_speed, bytes, offset + 20);
			bytes[offset + 24] = msg.storage_id;
			bytes[offset + 25] = msg.storage_count;
			bytes[offset + 26] = msg.status;
			offset += 27;
			return 261;
		}

		internal static int Serialize_CAMERA_CAPTURE_STATUS(this Msg_camera_capture_status msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bitconverter.GetBytes(msg.image_interval, bytes, offset + 4);
			bitconverter.GetBytes(msg.recording_time_ms, bytes, offset + 8);
			bitconverter.GetBytes(msg.available_capacity, bytes, offset + 12);
			bytes[offset + 16] = msg.image_status;
			bytes[offset + 17] = msg.video_status;
			offset += 18;
			return 262;
		}

		internal static int Serialize_CAMERA_IMAGE_CAPTURED(this Msg_camera_image_captured msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_utc, bytes, offset + 0);
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 8);
			bitconverter.GetBytes(msg.lat, bytes, offset + 12);
			...
			ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 28, 4);
			bitconverter.GetBytes(msg.image_index, bytes, offset + 44);
			bytes[offset + 48] = msg.camera_id;
			bytes[offset + 49] = unchecked((byte)msg.capture_result);
			ByteArrayUtil.ToByteArray(msg.file_url, bytes, offset + 50, 205);
			offset += 255;
			return 263;
		}

		internal static int Serialize_FLIGHT_INFORMATION(this Msg_flight_information msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.arming_time_utc, bytes, offset + 0);
			bitconverter.GetBytes(msg.takeoff_time_utc, bytes, offset + 8);
			bitconverter.GetBytes(msg.flight_uuid, bytes, offset + 16);
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 24);
			offset += 28;
			return 264;
		}

		internal static int Serialize_MOUNT_ORIENTATION(this Msg_mount_orientation msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
			bitconverter.GetBytes(msg.roll, bytes, offset + 4);
			bitconverter.GetBytes(msg.pitch, bytes, offset + 8);
		...
		internal static int Serialize_LOGGING_DATA(this Msg_logging_data msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.sequence, bytes, offset + 0);
			bytes[offset + 2] = msg.target_system;
			bytes[offset + 3] = msg.target_component;
			bytes[offset + 4] = msg.length;
			bytes[offset + 5] = msg.first_message_offset;
			ByteArrayUtil.ToByteArray(msg.data, bytes, offset + 6, 249);
			offset += 255;
			return 266;
		}

		internal static int Serialize_LOGGING_DATA_ACKED(this Msg_logging_data_acked msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.sequence, bytes, offset + 0);
			bytes[offset + 2] = msg.target_system;
			bytes[offset + 3] = msg.target_component;
		...
		internal static int Serialize_LOGGING_ACK(this Msg_logging_ack msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.sequence, bytes, offset + 0);
			bytes[offset + 2] = msg.target_system;
			bytes[offset + 3] = msg.target_component;
		...
		internal static int Serialize_VIDEO_STREAM_INFORMATION(this Msg_video_stream_information msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.framerate, bytes, offset + 0);
			bitconverter.GetBytes(msg.bitrate, bytes, offset + 4);
			bitconverter.GetBytes(msg.resolution_h, bytes, offset + 8);
			bitconverter.GetBytes(msg.resolution_v, bytes, offset + 10);
			bitconverter.GetBytes(msg.rotation, bytes, offset + 12);
			bytes[offset + 14] = msg.camera_id;
			bytes[offset + 15] = msg.status;
			ByteArrayUtil.ToByteArray(msg.uri, bytes, offset + 16, 230);
			offset += 246;
			return 269;
		}

		internal static int Serialize_SET_VIDEO_STREAM_SETTINGS(this Msg_set_video_stream_settings msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.framerate, bytes, offset + 0);
			bitconverter.GetBytes(msg.bitrate, bytes, offset + 4);
			bitconverter.GetBytes(msg.resolution_h, bytes, offset + 8);
			...
			bytes[offset + 16] = msg.camera_id;
			ByteArrayUtil.ToByteArray(msg.uri, bytes, offset + 17, 230);
			offset += 247;
			return 270;
		}

		internal static int Serialize_WIFI_CONFIG_AP(this Msg_wifi_config_ap msg, byte[] bytes, ref int offset)
		{
			ByteArrayUtil.ToByteArray(msg.ssid, bytes, offset + 0, 32);
			ByteArrayUtil.ToByteArray(msg.password, bytes, offset + 32, 64);
			offset += 96;
			return 299;
		}

		internal static int Serialize_PROTOCOL_VERSION(this Msg_protocol_version msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.version, bytes, offset + 0);
			bitconverter.GetBytes(msg.min_version, bytes, offset + 2);
			bitconverter.GetBytes(msg.max_version, bytes, offset + 4);
			ByteArrayUtil.ToByteArray(msg.spec_version_hash, bytes, offset + 6, 8);
			ByteArrayUtil.ToByteArray(msg.library_version_hash, bytes, offset + 14, 8);
			offset += 22;
			return 300;
		}

		internal static int Serialize_UAVCAN_NODE_STATUS(this Msg_uavcan_node_status msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
			bitconverter.GetBytes(msg.uptime_sec, bytes, offset + 8);
			bitconverter.GetBytes(msg.vendor_specific_status_code, bytes, offset + 12);
			bytes[offset + 14] = msg.health;
			bytes[offset + 15] = msg.mode;
			bytes[offset + 16] = msg.sub_mode;
			offset += 17;
			return 310;
		}

		internal static int Serialize_UAVCAN_NODE_INFO(this Msg_uavcan_node_info msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
			bitconverter.GetBytes(msg.uptime_sec, bytes, offset + 8);
			bitconverter.GetBytes(msg.sw_vcs_commit, bytes, offset + 12);
			ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 16, 80);
			bytes[offset + 96] = msg.hw_version_major;
			bytes[offset + 97] = msg.hw_version_minor;
			ByteArrayUtil.ToByteArray(msg.hw_unique_id, bytes, offset + 98, 16);
			bytes[offset + 114] = msg.sw_version_major;
			bytes[offset + 115] = msg.sw_version_minor;
			offset += 116;
			return 311;
		}

		internal static int Serialize_PARAM_EXT_REQUEST_READ(this Msg_param_ext_request_read msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.param_index, bytes, offset + 0);
			bytes[offset + 2] = msg.target_system;
			bytes[offset + 3] = msg.target_component;
		...
		internal static int Serialize_PARAM_EXT_REQUEST_LIST(this Msg_param_ext_request_list msg, byte[] bytes, ref int offset)
		{
			bytes[offset + 0] = msg.target_system;
			bytes[offset + 1] = msg.target_component;
			offset += 2;
		...
		internal static int Serialize_PARAM_EXT_VALUE(this Msg_param_ext_value msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.param_count, bytes, offset + 0);
			bitconverter.GetBytes(msg.param_index, bytes, offset + 2);
			ByteArrayUtil.ToByteArray(msg.param_id, bytes, offset + 4, 16);
			ByteArrayUtil.ToByteArray(msg.param_value, bytes, offset + 20, 128);
			bytes[offset + 148] = msg.param_type;
			offset += 149;
			return 322;
		}

		internal static int Serialize_PARAM_EXT_SET(this Msg_param_ext_set msg, byte[] bytes, ref int offset)
		{
			bytes[offset + 0] = msg.target_system;
			bytes[offset + 1] = msg.target_component;
			ByteArrayUtil.ToByteArray(msg.param_id, bytes, offset + 2, 16);
			ByteArrayUtil.ToByteArray(msg.param_value, bytes, offset + 18, 128);
			bytes[offset + 146] = msg.param_type;
			offset += 147;
			return 323;
		}

		internal static int Serialize_PARAM_EXT_ACK(this Msg_param_ext_ack msg, byte[] bytes, ref int offset)
		{
			ByteArrayUtil.ToByteArray(msg.param_id, bytes, offset + 0, 16);
			ByteArrayUtil.ToByteArray(msg.param_value, bytes, offset + 16, 128);
			bytes[offset + 144] = msg.param_type;
			bytes[offset + 145] = msg.param_result;
			offset += 146;
			return 324;
		}
	}

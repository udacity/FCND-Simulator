...
public class Scenario2 : MonoBehaviour
{
    ...
    public float targetAltitude = 200.0f;
    /*
    ...
    private void FixedUpdate()
    {
        ...
        */
        ...
        if(Time.time-initTime < 5)
            drone.CommandAttitude(new Vector3(0.0f, targetAltitude-50.0f, 0.0f), targetAirspeed);
        else
            drone.CommandAttitude(new Vector3(0.0f, targetAltitude, 0.0f), targetAirspeed);

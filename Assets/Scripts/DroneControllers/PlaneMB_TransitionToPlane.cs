...
{
    [CreateAssetMenu(menuName = "MovementBehaviors/To Plane Transition")]
    public class PlaneMB_TransitionToPlane : PlaneMovementBehavior
    {
        ...
        public override void OnLateUpdate()
        {
            ...
            throttle = QuadPlaneControl.toPlaneThrottle;
            aileron = 0f;
            elevator = 0f;
            rudder = 0;

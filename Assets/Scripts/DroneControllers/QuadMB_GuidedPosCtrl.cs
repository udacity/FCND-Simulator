...
{
	[CreateAssetMenu (menuName = "MovementBehaviors/Quad Guided Pos Ctrl")]
	public class QuadMB_GuidedPosCtrl : QuadMovementBehavior
	{
...
//			}
			...
			if (controller.guided || controller.posctl || controller.stabilized)
			{
